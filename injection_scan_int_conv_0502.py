...
def sipm_injection_scan(i2csocket,daqsocket,clisocket,basedir,device_name,injectionConfig,suffix='',keepRawData=1,analysis=1):
    ...
    odir = "%s/%s/TB3_D8_11/ConvInjectionTRIG1_Lat1_D8_11/"%( os.path.realpath(basedir), device_name) # a complete path is needed
    ...
    daqsocket.yamlConfig['daq']['menus']['calibAndL1AplusTPG']['trg_fifo_latency']=1 # set to 1 or 2
...
if __name__ == "__main__":
    ...
    injectionConfig = {
        ...
        'calib' : [i for i in range(0,4000,25)],
        'injectedChannels' : [6, 41]  # TRIG1
